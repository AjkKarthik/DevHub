...
**Progress so far: 113/451 files done** (Node.js 23, Security 17, System Design 17, MongoDB 18, Observability 19, JavaScript 15, HTML 4). Each hub built, committed, and pushed individually. Two recurring authoring bugs found and fixed during this pass — noted here so future sessions don't repeat them:
