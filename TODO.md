...
**Progress so far: 152/451 files done** (Node.js 23, Security 17, System Design 17, MongoDB 18, Observability 19, API Design 19, CSS 20, JavaScript 15, HTML 4). Each hub built, committed, and pushed individually. Two recurring authoring bugs found and fixed during this pass — noted here so future sessions don't repeat them:
