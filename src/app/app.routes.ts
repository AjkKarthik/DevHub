...
export const routes: Routes = [
  ...
  { path: 'mongodb', children: [
    ...
    { path: 'lookup-joins', children: [
      { path: '', loadComponent: () => import('./components/data/mongodb/lookup-joins/lookup-joins').then(m => m.MongoLookupJoins) },
      { path: 'lookup-is-actually-supported-inside-facet-sub-pipelines', loadComponent: () => import('./components/data/mongodb/lookup-joins/subtopics/lookup-is-actually-supported-inside-facet-sub-pipelines/lookup-is-actually-supported-inside-facet-sub-pipelines').then(m => m.LookupIsActuallySupportedInsideFacetSubPipelinesSubtopic) },
  ...
  { path: 'redis', children: [
    ...
    { path: 'redis-cluster', children: [
      { path: '', loadComponent: () => import('./components/data/redis/redis-cluster/redis-cluster').then(m => m.RedisCluster) },
      { path: 'the-live-resharding-state-machine-migrating-importing-ask-moved', loadComponent: () => import('./components/data/redis/redis-cluster/subtopics/the-live-resharding-state-machine-migrating-importing-ask-moved/the-live-resharding-state-machine-migrating-importing-ask-moved').then(m => m.TheLiveReshardingStateMachineMigratingImportingAskMovedSubtopic) },
  ...
  { path: 'graphql', children: [
    ...
    { path: 'fundamentals', children: [
      { path: '', loadComponent: () => import('./components/data/graphql/fundamentals/fundamentals').then(m => m.GqlFundamentals) },
      { path: 'post-type-missing-author-field', loadComponent: () => import('./components/data/graphql/fundamentals/subtopics/post-type-missing-author-field/post-type-missing-author-field').then(m => m.PostTypeMissingAuthorFieldSubtopic) },
    ...
    { path: 'dataloader', children: [
      { path: '', loadComponent: () => import('./components/data/graphql/dataloader/dataloader').then(m => m.GqlDataloader) },
      { path: 'default-scheduler-microtask-then-nexttick', loadComponent: () => import('./components/data/graphql/dataloader/subtopics/default-scheduler-microtask-then-nexttick/default-scheduler-microtask-then-nexttick').then(m => m.DefaultSchedulerMicrotaskThenNexttickSubtopic) },
  ...
  { path: 'api-design', children: [
    ...
    { path: 'hateoas-hypermedia', children: [
        { path: '', loadComponent: () => import('./components/architecture/api-design/hateoas-hypermedia/hateoas-hypermedia').then(m => m.ApiHateoas) },
        { path: 'the-missing-json-parse-in-the-link-following-example', loadComponent: () => import('./components/architecture/api-design/hateoas-hypermedia/subtopics/the-missing-json-parse-in-the-link-following-example/the-missing-json-parse-in-the-link-following-example').then(m => m.TheMissingJsonParseInTheLinkFollowingExampleSubtopic) },
  ...
  { path: 'system-design',   children: [
    ...
    { path: 'replication', children: [
      { path: '', loadComponent: () => import('./components/architecture/system-design/replication/replication').then(m => m.SysdesignReplication) },
      { path: 'postgresqls-synchronous-standby-names-needs-a-quoted-name', loadComponent: () => import('./components/architecture/system-design/replication/subtopics/postgresqls-synchronous-standby-names-needs-a-quoted-name/postgresqls-synchronous-standby-names-needs-a-quoted-name').then(m => m.PostgresqlsSynchronousStandbyNamesNeedsAQuotedNameSubtopic) },
      { path: 'quorum-w-plus-r-over-n-guarantees-overlap-not-linearizability', loadComponent: () => import('./components/architecture/system-design/replication/subtopics/quorum-w-plus-r-over-n-guarantees-overlap-not-linearizability/quorum-w-plus-r-over-n-guarantees-overlap-not-linearizability').then(m => m.QuorumWPlusROverNGuaranteesOverlapNotLinearizabilitySubtopic) },
      { path: 'dynamodb-isnt-tunable-like-cassandra-its-a-binary-choice', loadComponent: () => import('./components/architecture/system-design/replication/subtopics/dynamodb-isnt-tunable-like-cassandra-its-a-binary-choice/dynamodb-isnt-tunable-like-cassandra-its-a-binary-choice').then(m => m.DynamodbIsntTunableLikeCassandraItsABinaryChoiceSubtopic) },
    ] },
    { path: 'indexes', children: [
      { path: '', loadComponent: () => import('./components/architecture/system-design/indexes/indexes').then(m => m.SysdesignIndexes) },
      { path: 'mysql-innodb-auto-creates-the-fk-index-it-doesnt-just-warn', loadComponent: () => import('./components/architecture/system-design/indexes/subtopics/mysql-innodb-auto-creates-the-fk-index-it-doesnt-just-warn/mysql-innodb-auto-creates-the-fk-index-it-doesnt-just-warn').then(m => m.MysqlInnodbAutoCreatesTheFkIndexItDoesntJustWarnSubtopic) },
      { path: 'reindex-concurrently-avoids-write-locks-but-isnt-fully-lock-free', loadComponent: () => import('./components/architecture/system-design/indexes/subtopics/reindex-concurrently-avoids-write-locks-but-isnt-fully-lock-free/reindex-concurrently-avoids-write-locks-but-isnt-fully-lock-free').then(m => m.ReindexConcurrentlyAvoidsWriteLocksButIsntFullyLockFreeSubtopic) },
      { path: 'the-full-rule-is-equality-sort-range-not-just-equality-then-range', loadComponent: () => import('./components/architecture/system-design/indexes/subtopics/the-full-rule-is-equality-sort-range-not-just-equality-then-range/the-full-rule-is-equality-sort-range-not-just-equality-then-range').then(m => m.TheFullRuleIsEqualitySortRangeNotJustEqualityThenRangeSubtopic) },
    ] },
    { path: 'distributed-transactions', children: [
      { path: '', loadComponent: () => import('./components/architecture/system-design/distributed-transactions/distributed-transactions').then(m => m.SysdesignDistributedTransactions) },
      { path: 'the-idempotency-key-example-used-date-now-defeating-retries', loadComponent: () => import('./components/architecture/system-design/distributed-transactions/subtopics/the-idempotency-key-example-used-date-now-defeating-retries/the-idempotency-key-example-used-date-now-defeating-retries').then(m => m.TheIdempotencyKeyExampleUsedDateNowDefeatingRetriesSubtopic) },
      { path: 'kafka-offset-committing-is-specific-to-consume-transform-produce', loadComponent: () => import('./components/architecture/system-design/distributed-transactions/subtopics/kafka-offset-committing-is-specific-to-consume-transform-produce/kafka-offset-committing-is-specific-to-consume-transform-produce').then(m => m.KafkaOffsetCommittingIsSpecificToConsumeTransformProduceSubtopic) },
      { path: 'tccs-timeout-recovery-still-needs-a-transaction-manager', loadComponent: () => import('./components/architecture/system-design/distributed-transactions/subtopics/tccs-timeout-recovery-still-needs-a-transaction-manager/tccs-timeout-recovery-still-needs-a-transaction-manager').then(m => m.TccsTimeoutRecoveryStillNeedsATransactionManagerSubtopic) },
    ] },
    { path: 'high-availability', children: [
      { path: '', loadComponent: () => import('./components/architecture/system-design/high-availability/high-availability').then(m => m.SysdesignHighAvailability) },
      { path: 'rds-multi-az-db-clusters-fail-over-in-under-35-seconds-not-just-60-120', loadComponent: () => import('./components/architecture/system-design/high-availability/subtopics/rds-multi-az-db-clusters/rds-multi-az-db-clusters').then(m => m.RdsMultiAzDbClustersFailOverInUnder35SecondsNotJust60120Subtopic) },
  ...
  { path: 'observability', children: [
    ...
    { path: 'cloud-native-monitoring', children: [
        { path: '', loadComponent: () => import('./components/architecture/observability/cloud-native-monitoring/cloud-native-monitoring').then(m => m.ObsCloudNativeMonitoring) },
        { path: 'the-command-override-that-drops-config-file', loadComponent: () => import('./components/architecture/observability/cloud-native-monitoring/subtopics/the-command-override-that-drops-config-file/the-command-override-that-drops-config-file').then(m => m.TheCommandOverrideThatDropsConfigFileSubtopic) },
  ...
  { path: 'containers',    children: [
    ...
    { path: 'storage', children: [
      { path: '', loadComponent: () => import('./components/cloud/containers/storage/storage').then(m => m.K8sStorage) },
      { path: 'released-pv-never-auto-rebinds-claimref-must-be-cleared-manually', loadComponent: () => import('./components/cloud/containers/storage/subtopics/released-pv-never-auto-rebinds-claimref-must-be-cleared-manually/released-pv-never-auto-rebinds-claimref-must-be-cleared-manually').then(m => m.ReleasedPvNeverAutoRebindsClaimrefMustBeClearedManuallySubtopic) },
      { path: 'a-zonal-pvc-can-strand-a-rescheduled-statefulset-pod-in-pending', loadComponent: () => import('./components/cloud/containers/storage/subtopics/a-zonal-pvc-can-strand-a-rescheduled-statefulset-pod-in-pending/a-zonal-pvc-can-strand-a-rescheduled-statefulset-pod-in-pending').then(m => m.AZonalPvcCanStrandARescheduledStatefulsetPodInPendingSubtopic) },
      { path: 'rwop-closes-the-gap-rwo-leaves-same-node-pods-can-still-double-write', loadComponent: () => import('./components/cloud/containers/storage/subtopics/rwop-closes-the-gap-rwo-leaves-same-node-pods-can-still-double-write/rwop-closes-the-gap-rwo-leaves-same-node-pods-can-still-double-write').then(m => m.RwopClosesTheGapRwoLeavesSameNodePodsCanStillDoubleWriteSubtopic) },
    ]},
    ...
    { path: 'statefulsets', children: [
      { path: '', loadComponent: () => import('./components/cloud/containers/statefulsets/statefulsets').then(m => m.K8sStatefulsets) },
      { path: 'pdb-only-blocks-voluntary-disruptions-a-node-crash-ignores-it-entirely', loadComponent: () => import('./components/cloud/containers/statefulsets/subtopics/pdb-only-blocks-voluntary-disruptions-a-node-crash-ignores-it-entirely/pdb-only-blocks-voluntary-disruptions-a-node-crash-ignores-it-entirely').then(m => m.PdbOnlyBlocksVoluntaryDisruptionsANodeCrashIgnoresItEntirelySubtopic) },
      { path: 'scaling-back-up-reattaches-the-old-pvc-with-its-old-data-silently', loadComponent: () => import('./components/cloud/containers/statefulsets/subtopics/scaling-back-up-reattaches-the-old-pvc-with-its-old-data-silently/scaling-back-up-reattaches-the-old-pvc-with-its-old-data-silently').then(m => m.ScalingBackUpReattachesTheOldPvcWithItsOldDataSilentlySubtopic) },
      { path: 'init-containers-share-the-pods-network-namespace-not-just-its-volumes', loadComponent: () => import('./components/cloud/containers/statefulsets/subtopics/init-containers-share-the-pods-network-namespace-not-just-its-volumes/init-containers-share-the-pods-network-namespace-not-just-its-volumes').then(m => m.InitContainersShareThePodsNetworkNamespaceNotJustItsVolumesSubtopic) },
    ]},
    { path: 'resource-limits', children: [
      { path: '', loadComponent: () => import('./components/cloud/containers/resource-limits/resource-limits').then(m => m.K8sResourceLimits) },
      { path: 'cpu-limit-throttling-triggers-on-a-100ms-burst-not-average-usage', loadComponent: () => import('./components/cloud/containers/resource-limits/subtopics/cpu-limit-throttling-triggers-on-a-100ms-burst-not-average-usage/cpu-limit-throttling-triggers-on-a-100ms-burst-not-average-usage').then(m => m.CpuLimitThrottlingTriggersOnA100msBurstNotAverageUsageSubtopic) },
  ...
  { path: 'service-mesh',  children: [
    ...
    { path: 'istio-architecture', children: [
      { path: '', loadComponent: () => import('./components/cloud/service-mesh/istio-architecture/istio-architecture').then(m => m.MeshIstioArchitecture) },
      { path: 'cert-rotation-overlaps-old-and-new-certs-to-avoid-handshake-failures', loadComponent: () => import('./components/cloud/service-mesh/istio-architecture/subtopics/cert-rotation-overlaps-old-and-new-certs-to-avoid-handshake-failures/cert-rotation-overlaps-old-and-new-certs-to-avoid-handshake-failures').then(m => m.CertRotationOverlapsOldAndNewCertsToAvoidHandshakeFailuresSubtopic) },
    ...
    { path: 'traffic-management', children: [
      { path: '', loadComponent: () => import('./components/cloud/service-mesh/traffic-management/traffic-management').then(m => m.MeshTrafficManagement) },
      { path: 'fault-injection-and-retries-cannot-coexist-on-the-same-route', loadComponent: () => import('./components/cloud/service-mesh/traffic-management/subtopics/fault-injection-and-retries-cannot-coexist-on-the-same-route/fault-injection-and-retries-cannot-coexist-on-the-same-route').then(m => m.FaultInjectionAndRetriesCannotCoexistOnTheSameRouteSubtopic) },
