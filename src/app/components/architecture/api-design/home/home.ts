...
const ALL_TOPICS: Topic[] = [
  // REST
  { title: 'REST Fundamentals',         route: '/api-design/rest-fundamentals',        badge: 'REST', available: true,
  ...
  { title: 'Resource & URL Design',     route: '/api-design/resource-url-design',      badge: 'REST', available: true,
  ...
  { title: 'HTTP Methods & Status Codes', route: '/api-design/http-methods-status-codes', badge: 'REST', available: true,
  ...
  { title: 'Pagination Patterns',       route: '/api-design/pagination-patterns',      badge: 'REST', available: true,
  ...
  { title: 'API Versioning Strategies', route: '/api-design/api-versioning',           badge: 'REST', available: true,
  ...
  { title: 'Error Response Design',     route: '/api-design/error-response-design',    badge: 'REST', available: true,
  ...
  { title: 'HATEOAS & Hypermedia',      route: '/api-design/hateoas-hypermedia',       badge: 'REST', available: true,
  ...
  // gRPC
  { title: 'Protocol Buffers',          route: '/api-design/protocol-buffers',         badge: 'gRPC', available: true,
  ...
  { title: 'gRPC Service Patterns',     route: '/api-design/grpc-service-patterns',    badge: 'gRPC', available: true,
  ...
  { title: 'gRPC-Web & Transcoding',    route: '/api-design/grpc-web-transcoding',     badge: 'gRPC', available: true,
  ...
  // GraphQL
  { title: 'GraphQL Fundamentals',      route: '/api-design/graphql-fundamentals',     badge: 'GraphQL', available: true,
  ...
  { title: 'GraphQL vs REST',           route: '/api-design/graphql-vs-rest',          badge: 'GraphQL', available: true,
  ...
  // Real-Time
  { title: 'WebSockets vs SSE vs Polling', route: '/api-design/websockets-sse-polling', badge: 'Real-Time', available: true,
  ...
  { title: 'Webhook Design',            route: '/api-design/webhook-design',           badge: 'Real-Time', available: true,
  ...
  // Design
  { title: 'API Design Principles',     route: '/api-design/api-design-principles',    badge: 'Design', available: true,
  ...
  { title: 'OpenAPI & API Contracts',   route: '/api-design/openapi-contracts',        badge: 'Design', available: true,
  ...
  { title: 'API Security',              route: '/api-design/api-security',             badge: 'Design', available: true,
  ...
  { title: 'Breaking vs Non-Breaking Changes', route: '/api-design/breaking-changes', badge: 'Design', available: true,
  ...
  { title: 'API Rate Limiting & Throttling', route: '/api-design/rate-limiting',      badge: 'Design', available: true,
  ...
  // Reference
  { title: 'API Design Cheat Sheet',    route: '/api-design/cheatsheet',               badge: 'Reference', available: true,
  ...
  { title: 'API Interview Prep',        route: '/api-design/interview-prep',            badge: 'Reference', available: true,
    description: '15 API design interview questions — REST constraints, status codes, versioning, GraphQL trade-offs.',
    keyPoints: ['Junior: status codes, HTTP methods, REST principles', 'Mid: versioning, pagination, error design', 'Senior: GraphQL vs REST, JWT security, breaking changes'] },
];
