...
const ALL_TOPICS: Topic[] = [
  // Fundamentals
  { title: 'System Design Framework',   route: '/system-design', badge: 'Fundamentals', available: false,
  ...
  { title: 'Capacity Estimation',       route: '/system-design', badge: 'Fundamentals', available: false,
  ...
  { title: 'CAP & PACELC Theorems',     route: '/system-design', badge: 'Fundamentals', available: false,
  ...
  { title: 'Networking Fundamentals',   route: '/system-design', badge: 'Fundamentals', available: false,
  ...
  // Scalability
  { title: 'Horizontal vs Vertical Scaling', route: '/system-design', badge: 'Scalability', available: false,
  ...
  { title: 'Load Balancing',            route: '/system-design', badge: 'Scalability', available: false,
  ...
  { title: 'Caching Strategies',        route: '/system-design', badge: 'Scalability', available: false,
  ...
  { title: 'Content Delivery Networks', route: '/system-design', badge: 'Scalability', available: false,
  ...
  { title: 'Database Sharding',         route: '/system-design', badge: 'Scalability', available: false,
  ...
  // Data
  { title: 'SQL vs NoSQL',              route: '/system-design', badge: 'Data', available: false,
  ...
  { title: 'Replication Strategies',    route: '/system-design', badge: 'Data', available: false,
  ...
  { title: 'Indexes & Query Optimisation', route: '/system-design', badge: 'Data', available: false,
  ...
  { title: 'Distributed Transactions',  route: '/system-design', badge: 'Data', available: false,
  ...
  // Reliability
  { title: 'High Availability Design',  route: '/system-design', badge: 'Reliability', available: false,
  ...
  { title: 'Fault Tolerance Patterns',  route: '/system-design', badge: 'Reliability', available: false,
  ...
  { title: 'Distributed Tracing',       route: '/system-design', badge: 'Reliability', available: false,
  ...
  { title: 'Disaster Recovery',         route: '/system-design', badge: 'Reliability', available: false,
  ...
  // Real Systems
  { title: 'Design a URL Shortener',    route: '/system-design', badge: 'Real Systems', available: false,
  ...
  { title: 'Design a Social Feed',      route: '/system-design', badge: 'Real Systems', available: false,
  ...
  { title: 'Design a Chat Application', route: '/system-design', badge: 'Real Systems', available: false,
  ...
  { title: 'Design a Search Engine',    route: '/system-design', badge: 'Real Systems', available: false,
  ...
  { title: 'Design a Payment System',   route: '/system-design', badge: 'Real Systems', available: false,
  ...
  { title: 'Design Netflix / YouTube',  route: '/system-design', badge: 'Real Systems', available: false,
  ...
  { title: 'System Design Interview Guide', route: '/system-design', badge: 'Reference', available: false,
