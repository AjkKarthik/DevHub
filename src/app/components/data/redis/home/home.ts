...
const ALL_TOPICS: Topic[] = [
  ...
  { title: 'Redis Stack & Modules', route: '/redis', badge: 'Data Structures', description: 'Redis Stack bundles RedisJSON, RediSearch, RedisTimeSeries, and RedisBloom for extended data capabilities.', keyPoints: ['RedisJSON: native JSON.SET/GET/MGET — store and query JSON without serialization', 'RediSearch: full-text search + vector similarity search directly on Redis data', 'Vector search: FT.SEARCH with KNN for AI embedding retrieval (RAG, recommendations)', 'RedisTimeSeries: time-series ingestion, aggregation, and downsampling', 'RedisBloom: probabilistic structures — Bloom filter, Cuckoo filter, Count-Min Sketch'], available: false },
