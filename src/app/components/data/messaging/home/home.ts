...
const ALL_TOPICS: Topic[] = [
  ...
  { title: 'Kafka Connect', route: '/messaging', badge: 'Kafka', description: 'Scalable data integration framework for Kafka — source and sink connectors without writing producers/consumers.', keyPoints: ['Source connector: pull from DB/API → Kafka', 'Sink connector: Kafka → DB/storage/ES', 'Standalone vs distributed mode', 'SMT (Single Message Transform)', 'Confluent Hub connectors ecosystem'], available: false },
  { title: 'Schema Registry', route: '/messaging', badge: 'Kafka', description: 'Manage and enforce Avro/Protobuf/JSON schemas for Kafka messages — compatibility rules and schema evolution.', keyPoints: ['Confluent Schema Registry central store', 'BACKWARD / FORWARD / FULL compatibility modes', 'Schema ID in message header — producer registers, consumer retrieves', 'Avro: compact binary serialisation, schema embedded', 'Schema evolution: add optional fields (backward compatible)'], available: false },
