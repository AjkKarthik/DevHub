...
const ALL_TOPICS: Topic[] = [
  ...
  { title: 'Decorators & Context Managers', route: '/python', badge: 'OOP & Patterns', available: false,
  ...
  { title: 'File I/O & Pathlib',         route: '/python', badge: 'Data & Types', available: false,
  ...
  { title: 'Debugging & Profiling',      route: '/python', badge: 'Tooling', available: false,
  ...
  { title: 'SQLAlchemy',                 route: '/python', badge: 'Web & APIs', available: false,
  ...
  { title: 'Python Concurrency Patterns', route: '/python', badge: 'Async', available: false,
  ...
  { title: 'Celery & Task Queues',       route: '/python', badge: 'Web & APIs',  available: false,
