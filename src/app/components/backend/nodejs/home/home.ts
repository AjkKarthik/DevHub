...
const ALL_TOPICS: Topic[] = [
  { title: 'Node.js Architecture',      route: '/node/architecture', badge: 'Foundations', available: true,
  ...
  { title: 'Modules & CommonJS',        route: '/node/modules', badge: 'Foundations', available: true,
  ...
  { title: 'Node.js Core Modules',      route: '/node/core-modules', badge: 'Foundations', available: true,
  ...
  { title: 'Express.js',                route: '/node/express', badge: 'HTTP & APIs', available: true,
  ...
  { title: 'Fastify',                   route: '/node/fastify', badge: 'HTTP & APIs', available: true,
  ...
  { title: 'REST API Design in Node',   route: '/node/rest-api', badge: 'HTTP & APIs', available: true,
  ...
  { title: 'Promises & Async/Await',    route: '/node/promises-async', badge: 'Async & Streams', available: true,
  ...
  { title: 'Streams & Buffers',         route: '/node/streams', badge: 'Async & Streams', available: true,
  ...
  { title: 'Database with Prisma',      route: '/node/prisma', badge: 'Database', available: true,
  ...
  { title: 'MongoDB with Mongoose',     route: '/node/mongoose', badge: 'Database', available: true,
  ...
  { title: 'Auth with JWT & Passport',  route: '/node/jwt-auth', badge: 'Auth & Security', available: true,
  ...
  { title: 'Security Best Practices',   route: '/node/security', badge: 'Auth & Security', available: true,
  ...
  { title: 'Node.js Performance',       route: '/node/performance', badge: 'Performance', available: true,
  ...
  { title: 'Testing Node.js Apps',      route: '/node/testing', badge: 'Tooling', available: true,
  ...
  { title: 'Environment Config & dotenv',   route: '/node/env-config', badge: 'Foundations', available: true,
  ...
  { title: 'Error Handling Patterns',      route: '/node/error-handling', badge: 'Async & Streams', available: true,
  ...
  { title: 'Logging with Winston/Pino',    route: '/node/logging', badge: 'Performance', available: true,
  ...
  { title: 'WebSockets with Socket.io',    route: '/node/websockets', badge: 'HTTP & APIs', available: true,
  ...
  { title: 'GraphQL API with Node.js',     route: '/node/graphql', badge: 'HTTP & APIs', available: true,
  ...
  { title: 'Caching with Redis',           route: '/node/caching', badge: 'Performance', available: true,
  ...
  { title: 'Worker Threads',               route: '/node/worker-threads', badge: 'Performance', available: true,
  ...
  { title: 'Deploying Node.js Apps',       route: '/node/deployment', badge: 'Tooling', available: true,
  ...
  { title: 'NestJS',                     route: '/node/nestjs', badge: 'HTTP & APIs', available: true,
  ...
  { title: 'Node.js Cheat Sheet',       route: '/node/cheatsheet', badge: 'Reference', available: true,
  ...
  { title: 'Node.js Interview Prep',    route: '/node/interview-prep', badge: 'Reference', available: true,
