...
const ALL_TOPICS: CsharpTopic[] = [
  ...
  { title: 'Span<T> & Memory<T>',     route: '/csharp/span-memory',        badge: 'Modern', available: true,
  ...
  { title: 'Dependency Injection in .NET', route: '/csharp/di-dotnet',     badge: 'Modern', available: true,
  ...
  { title: 'System.Text.Json Advanced', route: '/csharp/json-advanced',     badge: 'Data', available: true,
  ...
  { title: 'Unsafe Code & Pointers',  route: '/csharp/unsafe-pointers',     badge: 'Advanced', available: true,
  ...
  { title: 'Native AOT',              route: '/csharp/native-aot',          badge: 'Advanced', available: true,
  ...
  { title: 'BenchmarkDotNet',         route: '/csharp/benchmarkdotnet',     badge: 'Advanced', available: true,
  ...
  { title: 'P/Invoke & Native Interop', route: '/csharp/pinvoke',           badge: 'Advanced', available: true,
  ...
  { title: '.NET CLI & Tooling',      route: '/csharp/dotnet-cli',          badge: 'Advanced', available: true,
