...
const ALL_TOPICS: Topic[] = [
  { title: 'Go Fundamentals',           route: '/go/fundamentals', badge: 'Foundations', available: false,
  ...
  { title: 'Structs & Interfaces',      route: '/go/structs-interfaces', badge: 'Foundations', available: false,
  ...
  { title: 'Error Handling',            route: '/go/error-handling', badge: 'Foundations', available: false,
  ...
  { title: 'Slices & Maps',             route: '/go/slices-maps', badge: 'Foundations', available: false,
  ...
  { title: 'Goroutines',                route: '/go/goroutines', badge: 'Concurrency', available: false,
  ...
  { title: 'Channels',                  route: '/go/channels', badge: 'Concurrency', available: false,
  ...
  { title: 'sync & sync/atomic',        route: '/go/sync', badge: 'Concurrency', available: false,
  ...
  { title: 'context Package',           route: '/go/context', badge: 'Concurrency', available: false,
  ...
  { title: 'net/http & REST APIs',      route: '/go/net-http', badge: 'HTTP & APIs', available: false,
  ...
  { title: 'Gin Web Framework',         route: '/go/gin', badge: 'HTTP & APIs', available: false,
  ...
  { title: 'JSON & Encoding',           route: '/go/json-encoding', badge: 'HTTP & APIs', available: false,
  ...
  { title: 'gRPC in Go',                route: '/go/grpc', badge: 'HTTP & APIs', available: false,
  ...
  { title: 'Database with pgx',         route: '/go/pgx', badge: 'Data & Storage', available: false,
  ...
  { title: 'GORM',                      route: '/go/gorm', badge: 'Data & Storage', available: false,
  ...
  { title: 'Go Generics',               route: '/go/generics', badge: 'Foundations', available: false,
  ...
  { title: 'Go Patterns',               route: '/go/patterns', badge: 'Patterns', available: false,
  ...
  { title: 'Go Modules',                route: '/go/modules', badge: 'Tooling', available: false,
  ...
  { title: 'Testing in Go',             route: '/go/testing', badge: 'Tooling', available: false,
  ...
  { title: 'Go CLI Tools',              route: '/go/cli', badge: 'Tooling', available: false,
  ...
  { title: 'Go Performance & Profiling', route: '/go/profiling', badge: 'Tooling', available: false,
  ...
  { title: 'Go Build & Deployment',     route: '/go/build', badge: 'Tooling', available: false,
  ...
  { title: 'Go Cheat Sheet',            route: '/go/cheatsheet', badge: 'Reference', available: false,
  ...
  { title: 'Go Interview Prep',         route: '/go/interview-prep', badge: 'Reference', available: false,
