...
const ALL_TOPICS: AspnetTopic[] = [
  // ── Fundamentals ──
  { title: 'Hosting & Startup',        route: '/aspnet/hosting-startup',  badge: 'Fundamentals', available: false,
  ...
  { title: 'Middleware Pipeline',      route: '/aspnet/middleware',       badge: 'Fundamentals', available: false,
  ...
  { title: 'Routing',                  route: '/aspnet/routing',          badge: 'Fundamentals', available: false,
  ...
  { title: 'Configuration & Options',  route: '/aspnet/configuration',    badge: 'Fundamentals', available: false,
  ...
  { title: 'Dependency Injection',     route: '/aspnet/dependency-injection', badge: 'Fundamentals', available: false,
  ...
  { title: 'Logging & Diagnostics',    route: '/aspnet/logging',          badge: 'Fundamentals', available: false,
  ...
  { title: 'Static Files & Uploads',   route: '/aspnet/static-files',     badge: 'Fundamentals', available: false,
  ...
  // ── Web API ──
  { title: 'Controllers & Actions',    route: '/aspnet/controllers',      badge: 'Web API', available: false,
  ...
  { title: 'Minimal APIs',             route: '/aspnet/minimal-apis',     badge: 'Web API', available: false,
  ...
  { title: 'Model Binding & Validation', route: '/aspnet/model-binding',  badge: 'Web API', available: false,
  ...
  { title: 'Filters & Endpoint Filters', route: '/aspnet/filters',        badge: 'Web API', available: false,
  ...
  { title: 'Error Handling',           route: '/aspnet/error-handling',   badge: 'Web API', available: false,
  ...
  { title: 'OpenAPI & Swagger',        route: '/aspnet/openapi-swagger',  badge: 'Web API', available: false,
  ...
  { title: 'API Versioning',           route: '/aspnet/api-versioning',   badge: 'Web API', available: false,
  ...
  { title: 'HttpClient & Resilience',  route: '/aspnet/http-clients',     badge: 'Web API', available: false,
  ...
  { title: 'gRPC Services',            route: '/aspnet/grpc',             badge: 'Web API', available: false,
  ...
  // ── Data ──
  { title: 'EF Core Basics',           route: '/aspnet/ef-core-basics',   badge: 'Data', available: false,
  ...
  { title: 'EF Relationships & Migrations', route: '/aspnet/ef-relationships', badge: 'Data', available: false,
  ...
  { title: 'EF Core Performance & Concurrency', route: '/aspnet/ef-performance', badge: 'Data', available: false,
  ...
  { title: 'Caching',                  route: '/aspnet/caching',          badge: 'Data', available: false,
  ...
  // ── Security ──
  { title: 'Authentication',           route: '/aspnet/authentication',   badge: 'Security', available: false,
  ...
  { title: 'Authorization',            route: '/aspnet/authorization',    badge: 'Security', available: false,
  ...
  { title: 'CORS & Security Headers',  route: '/aspnet/cors',             badge: 'Security', available: false,
  ...
  { title: 'Rate Limiting',            route: '/aspnet/rate-limiting',    badge: 'Security', available: false,
  ...
  { title: 'Web Security Essentials',  route: '/aspnet/web-security',     badge: 'Security', available: false,
  ...
  { title: 'Secrets & Data Protection', route: '/aspnet/secrets',         badge: 'Security', available: false,
  ...
  // ── Quality ──
  { title: 'Testing',                  route: '/aspnet/testing',          badge: 'Quality', available: false,
  ...
  { title: 'Background Services',      route: '/aspnet/background-services', badge: 'Quality', available: false,
  ...
  { title: 'SignalR',                  route: '/aspnet/signalr',          badge: 'Quality', available: false,
  ...
  { title: 'Health Checks & Observability', route: '/aspnet/health-checks', badge: 'Quality', available: false,
  ...
  { title: 'Deployment',               route: '/aspnet/deployment',       badge: 'Quality', available: false,
  ...
  { title: 'Performance & Diagnostics', route: '/aspnet/performance',     badge: 'Quality', available: false,
  ...
  { title: '.NET Aspire',              route: '/aspnet/aspire',           badge: 'Quality', available: false,
