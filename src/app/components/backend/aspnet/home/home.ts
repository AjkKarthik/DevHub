...
const ALL_TOPICS: AspnetTopic[] = [
  ...
  { title: 'Feature Flags',            route: '/aspnet/feature-flags',    badge: 'Fundamentals', available: true,
  ...
  { title: 'Localization & Globalization', route: '/aspnet/localization', badge: 'Fundamentals', available: true,
  ...
  { title: 'FluentValidation',         route: '/aspnet/fluent-validation', badge: 'Web API', available: true,
  ...
  { title: 'Minimal API Advanced',     route: '/aspnet/minimal-api-advanced', badge: 'Web API', available: true,
  ...
  { title: 'Output Caching Advanced',  route: '/aspnet/output-caching-advanced', badge: 'Data', available: true,
  ...
  { title: 'Dapper & Raw SQL',         route: '/aspnet/dapper',           badge: 'Data', available: true,
  ...
  { title: 'Anti-forgery & CSRF',      route: '/aspnet/csrf',             badge: 'Security', available: true,
  ...
  { title: 'MassTransit',               route: '/aspnet/masstransit',      badge: 'Quality', available: true,
    description: 'Message bus abstraction for .NET — integrate RabbitMQ, Azure Service Bus, or SQS without coupling to a broker.',
    keyPoints: ['AddMassTransit(x => x.UsingRabbitMq(...)) in Program.cs', 'Consumers implement IConsumer<T> — no broker-specific code in your domain', 'Saga state machines: built-in orchestration with persistence', 'Request/Response pattern: RequestClient<T> for synchronous-feeling async', 'Outbox pattern built-in: transactional outbox to prevent dual-write'] },
  ...
  { title: 'Response Compression',     route: '/aspnet/response-compression', badge: 'Quality', available: true,
  ...
  { title: 'WebSockets',               route: '/aspnet/websockets',       badge: 'Quality', available: true,
  ...
  { title: 'YARP Reverse Proxy',       route: '/aspnet/yarp',             badge: 'Quality', available: true,
  ...
  { title: 'OpenTelemetry',            route: '/aspnet/opentelemetry',    badge: 'Quality', available: true,
