...
# Or: human evaluation on 10% sample to calibrate the LLM judge`,
  ...
  { q: 'What does BLEU score measure and what are its limitations?', options: ['Grammar quality', 'N-gram overlap between generated text and reference translations', 'Semantic similarity', 'Response length'], answer: 1, explanation: 'BLEU (Bilingual Evaluation Understudy): measures n-gram precision of generated text vs references. Widely used for machine translation. Limitations: does not capture meaning or fluency; favors short outputs; poor correlation with human judgment for open-ended generation tasks.' },
