...
test('returns Buzz for 10', () => { expect(fizzBuzz(10)).toBe('Buzz'); });`,
  ...
  { q: 'What is the single most important benefit of TDD?', options: ['100% code coverage', 'Forces better API design since you use the code before writing it', 'Faster development speed', 'Eliminates all bugs'], answer: 1, explanation: 'TDD forces you to design the public API from the consumer\'s perspective before implementation. Code written test-first tends to have cleaner interfaces, better separation of concerns, and lower coupling than code written then tested.' },
