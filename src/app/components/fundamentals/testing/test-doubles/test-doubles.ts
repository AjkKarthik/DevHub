...
test('charge saves receipt on success', () => {
  ...
  { q: 'What is a Dummy object and when do you use it?', a: 'A Dummy is a placeholder object passed to satisfy a parameter requirement but never actually used in the test. Example: const unusedLogger = {} as Logger; new OrderService(unusedLogger, realOrderRepo). Use dummies when a parameter is required by the constructor but irrelevant to the behaviour under test — avoids creating real or complex dependencies.' },
