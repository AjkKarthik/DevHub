...
// minWindow("a", "aa") → ""`,
  ...
  { q: 'What does the KMP failure function (LPS array) actually store at each index?', options: ['The character at that index', 'The length of the longest proper prefix that is also a suffix of the substring ending at that index', 'The number of times the character repeats', 'The index of the next mismatch'], answer: 1, explanation: 'LPS[i] = length of the longest proper prefix of pattern[0..i] that is also a suffix of pattern[0..i]. On a mismatch, KMP uses this to skip re-comparing characters it already knows match, avoiding backtracking in the text.' },
