...
@Component({
  ...
  template: `
    ...
    <div class="nav-group">
      ...
      <a routerLink="/system-design/distributed-tracing" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">Distributed Tracing</span>
        @if(p.isDone('sysdesign-distributed-tracing')){<span class="nl-done">✓</span>}
        @if(d('sysdesign-distributed-tracing');as v){<span class="nl-dot" [class]="'nl-dot--'+v"></span>}
        @if (subtopicsOf('distributed-tracing')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('distributed-tracing')"
                  (click)="toggleSubtopics('distributed-tracing', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('distributed-tracing'); as dtrSubs) {
        @if (isSubtopicsExpanded('distributed-tracing')) {
          <div class="nav-subtopics">
            @for (s of dtrSubs; track s.route) {
              <a [routerLink]="s.route" routerLinkActive="active" class="nav-subtopic-link">
                <span class="nl-text">{{ s.label }}</span>
              </a>
            }
      ...
      <a routerLink="/system-design/disaster-recovery" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">Disaster Recovery</span>
        @if(p.isDone('sysdesign-disaster-recovery')){<span class="nl-done">✓</span>}
        @if(d('sysdesign-disaster-recovery');as v){<span class="nl-dot" [class]="'nl-dot--'+v"></span>}
        @if (subtopicsOf('disaster-recovery')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('disaster-recovery')"
                  (click)="toggleSubtopics('disaster-recovery', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('disaster-recovery'); as drSubs) {
        @if (isSubtopicsExpanded('disaster-recovery')) {
          <div class="nav-subtopics">
            @for (s of drSubs; track s.route) {
              <a [routerLink]="s.route" routerLinkActive="active" class="nav-subtopic-link">
                <span class="nl-text">{{ s.label }}</span>
              </a>
            }
    ...
    <div class="nav-group">
      ...
      <a routerLink="/system-design/url-shortener" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">Design a URL Shortener</span>
        @if(p.isDone('sysdesign-url-shortener')){<span class="nl-done">✓</span>}
        @if(d('sysdesign-url-shortener');as v){<span class="nl-dot" [class]="'nl-dot--'+v"></span>}
        @if (subtopicsOf('url-shortener')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('url-shortener')"
                  (click)="toggleSubtopics('url-shortener', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('url-shortener'); as usSubs) {
        @if (isSubtopicsExpanded('url-shortener')) {
          <div class="nav-subtopics">
            @for (s of usSubs; track s.route) {
              <a [routerLink]="s.route" routerLinkActive="active" class="nav-subtopic-link">
                <span class="nl-text">{{ s.label }}</span>
              </a>
            }
      ...
      <a routerLink="/system-design/social-feed" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">Design a Social Feed</span>
        @if(p.isDone('sysdesign-social-feed')){<span class="nl-done">✓</span>}
        @if(d('sysdesign-social-feed');as v){<span class="nl-dot" [class]="'nl-dot--'+v"></span>}
        @if (subtopicsOf('social-feed')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('social-feed')"
                  (click)="toggleSubtopics('social-feed', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('social-feed'); as sfSubs) {
        @if (isSubtopicsExpanded('social-feed')) {
          <div class="nav-subtopics">
      ...
      <a routerLink="/system-design/chat-application" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">Design a Chat Application</span>
        @if(p.isDone('sysdesign-chat-application')){<span class="nl-done">✓</span>}
        @if(d('sysdesign-chat-application');as v){<span class="nl-dot" [class]="'nl-dot--'+v"></span>}
        @if (subtopicsOf('chat-application')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('chat-application')"
                  (click)="toggleSubtopics('chat-application', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('chat-application'); as caSubs) {
        @if (isSubtopicsExpanded('chat-application')) {
          <div class="nav-subtopics">
      ...
      <a routerLink="/system-design/video-streaming" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">Design Netflix / YouTube</span>
        @if(p.isDone('sysdesign-video-streaming')){<span class="nl-done">✓</span>}
        @if(d('sysdesign-video-streaming');as v){<span class="nl-dot" [class]="'nl-dot--'+v"></span>}
        @if (subtopicsOf('video-streaming')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('video-streaming')"
                  (click)="toggleSubtopics('video-streaming', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('video-streaming'); as vsSubs) {
        @if (isSubtopicsExpanded('video-streaming')) {
          <div class="nav-subtopics">
