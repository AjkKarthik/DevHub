...
@Component({
  ...
  template: `
    ...
    <div class="nav-group">
      ...
      <a routerLink="/mongodb/security" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">Security &amp; Auth</span>
        @if(p.isDone('mongo-security')){<span class="nl-done">✓</span>}
        @if (subtopicsOf('mongo-security')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('mongo-security')"
                  (click)="toggleSubtopics('mongo-security', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('mongo-security'); as secSubs) {
        @if (isSubtopicsExpanded('mongo-security')) {
          <div class="nav-subtopics">
      ...
      <a routerLink="/mongodb/atlas-search" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">Atlas &amp; Vector Search</span>
        @if(p.isDone('mongo-atlas-search')){<span class="nl-done">✓</span>}
        @if (subtopicsOf('atlas-search')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('atlas-search')"
                  (click)="toggleSubtopics('atlas-search', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('atlas-search'); as asSubs) {
        @if (isSubtopicsExpanded('atlas-search')) {
          <div class="nav-subtopics">
