...
@Component({
  ...
  template: `
    ...
    <div class="nav-group">
      ...
      <a routerLink="/devops/gitops" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">GitOps (ArgoCD &amp; Flux)</span>
        @if (p.isDone('devops-gitops')) {<span class="nl-done">✓</span>}
        @if (d('devops-gitops'); as v) {<span class="nl-dot" [class]="'nl-dot--' + v"></span>}
        @if (subtopicsOf('gitops')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('gitops')"
                  (click)="toggleSubtopics('gitops', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('gitops'); as gitopsSubs) {
        @if (isSubtopicsExpanded('gitops')) {
          <div class="nav-subtopics">
            @for (s of gitopsSubs; track s.route) {
              <a [routerLink]="s.route" routerLinkActive="active" class="nav-subtopic-link">
                <span class="nl-text">{{ s.label }}</span>
              </a>
            }
    ...
    <div class="nav-group">
      ...
      <a routerLink="/devops/kubernetes-deployments" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">Kubernetes Deployments</span>
        @if (p.isDone('devops-kubernetes-deployments')) {<span class="nl-done">✓</span>}
        @if (d('devops-kubernetes-deployments'); as v) {<span class="nl-dot" [class]="'nl-dot--' + v"></span>}
        @if (subtopicsOf('kubernetes-deployments')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('kubernetes-deployments')"
                  (click)="toggleSubtopics('kubernetes-deployments', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('kubernetes-deployments'); as k8sDepSubs) {
        @if (isSubtopicsExpanded('kubernetes-deployments')) {
          <div class="nav-subtopics">
            @for (s of k8sDepSubs; track s.route) {
              <a [routerLink]="s.route" routerLinkActive="active" class="nav-subtopic-link">
                <span class="nl-text">{{ s.label }}</span>
              </a>
            }
    ...
    <div class="nav-group">
      ...
      <a routerLink="/devops/monitoring" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">Monitoring &amp; Alerting</span>
        @if (p.isDone('devops-monitoring')) {<span class="nl-done">✓</span>}
        @if (d('devops-monitoring'); as v) {<span class="nl-dot" [class]="'nl-dot--' + v"></span>}
        @if (subtopicsOf('monitoring')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('monitoring')"
                  (click)="toggleSubtopics('monitoring', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('monitoring'); as monSubs) {
        @if (isSubtopicsExpanded('monitoring')) {
          <div class="nav-subtopics">
      ...
      <a routerLink="/devops/incident-response" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">On-call &amp; Incident Response</span>
        @if (p.isDone('devops-incident-response')) {<span class="nl-done">✓</span>}
        @if (d('devops-incident-response'); as v) {<span class="nl-dot" [class]="'nl-dot--' + v"></span>}
        @if (subtopicsOf('incident-response')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('incident-response')"
                  (click)="toggleSubtopics('incident-response', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('incident-response'); as irSubs) {
        @if (isSubtopicsExpanded('incident-response')) {
          <div class="nav-subtopics">
            @for (s of irSubs; track s.route) {
              <a [routerLink]="s.route" routerLinkActive="active" class="nav-subtopic-link">
                <span class="nl-text">{{ s.label }}</span>
              </a>
            }
    ...
    <div class="nav-group">
      ...
      <a routerLink="/devops/sre" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">SRE Practices</span>
        @if (p.isDone('devops-sre')) {<span class="nl-done">✓</span>}
        @if (d('devops-sre'); as v) {<span class="nl-dot" [class]="'nl-dot--' + v"></span>}
        @if (subtopicsOf('sre')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('sre')"
                  (click)="toggleSubtopics('sre', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('sre'); as sreSubs) {
        @if (isSubtopicsExpanded('sre')) {
          <div class="nav-subtopics">
            @for (s of sreSubs; track s.route) {
              <a [routerLink]="s.route" routerLinkActive="active" class="nav-subtopic-link">
                <span class="nl-text">{{ s.label }}</span>
              </a>
            }
