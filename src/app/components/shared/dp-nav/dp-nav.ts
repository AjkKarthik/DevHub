...
@Component({
  ...
  template: `
    ...
    <div class="nav-group">
      ...
      <a routerLink="/design-patterns/saga" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">Saga Pattern</span>
        @if(p.isDone('dp-saga')){<span class="nl-done">✓</span>}
        @if(d('dp-saga');as v){<span class="nl-dot" [class]="'nl-dot--'+v"></span>}
        @if (subtopicsOf('saga')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('saga')"
                  (click)="toggleSubtopics('saga', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('saga'); as sagaSubs) {
        @if (isSubtopicsExpanded('saga')) {
          <div class="nav-subtopics">
      ...
      <a routerLink="/design-patterns/specification" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">Specification Pattern</span>
        @if(p.isDone('dp-specification')){<span class="nl-done">✓</span>}
        @if(d('dp-specification');as v){<span class="nl-dot" [class]="'nl-dot--'+v"></span>}
        @if (subtopicsOf('specification')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('specification')"
                  (click)="toggleSubtopics('specification', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('specification'); as specSubs) {
        @if (isSubtopicsExpanded('specification')) {
          <div class="nav-subtopics">
            @for (s of specSubs; track s.route) {
              <a [routerLink]="s.route" routerLinkActive="active" class="nav-subtopic-link">
                <span class="nl-text">{{ s.label }}</span>
              </a>
            }
    ...
    <div class="nav-group">
      ...
      <a routerLink="/design-patterns/solid" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
        <span class="nl-text">SOLID Principles</span>
        @if(p.isDone('dp-solid')){<span class="nl-done">✓</span>}
        @if(d('dp-solid');as v){<span class="nl-dot" [class]="'nl-dot--'+v"></span>}
        @if (subtopicsOf('solid')) {
          <button type="button" class="nav-subtopics-toggle" [class.open]="isSubtopicsExpanded('solid')"
                  (click)="toggleSubtopics('solid', $event)" aria-label="Toggle subtopics">›</button>
        }
      </a>
      @if (subtopicsOf('solid'); as solidSubs) {
        @if (isSubtopicsExpanded('solid')) {
          <div class="nav-subtopics">
            @for (s of solidSubs; track s.route) {
              <a [routerLink]="s.route" routerLinkActive="active" class="nav-subtopic-link">
                <span class="nl-text">{{ s.label }}</span>
              </a>
            }
