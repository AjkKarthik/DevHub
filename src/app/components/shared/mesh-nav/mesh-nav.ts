...
@Component({
  ...
  template: `
    ...
    <div class="nav-group">
      ...
      <a routerLink="/service-mesh/fundamentals" routerLinkActive="active"><span class="nl-text">Service Mesh Fundamentals</span>@if(p.isDone('mesh-fundamentals')){<span class="nl-done">✓</span>}@if(d('mesh-fundamentals');as v){<span class="nl-dot" [class]="'nl-dot--'+v"></span>}</a>
