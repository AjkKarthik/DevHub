...
const ALL_TOPICS: Topic[] = [
  ...
  { title: 'Accessibility (a11y)',         route: '/angular',                    badge: 'UI',        available: false,
    description: 'Build accessible Angular apps — ARIA attributes, CDK a11y module, focus management, and WCAG 2.1 compliance.',
    keyPoints: ['CdkTrapFocus: trap keyboard focus inside modals and dialogs', 'LiveAnnouncer: announce dynamic updates to screen readers', 'Angular CDK a11y: FocusMonitor, AriaDescriber, HighContrastMode', 'RouterLink accessibility: always provide meaningful link text; avoid "click here"', 'axe-core + @axe-core/angular: automated WCAG violation scanning in CI'] },
