...
export class AwsIamRoles {
  ...
  quickRef: QuickRefItem[] = [
    ...
    { name: 'External ID', type: 'keyword', desc: 'Confused-deputy protection — third-party must pass an unguessable, vendor-generated identifier when assuming your role. AWS does not treat it as a secret.' },
  ...
  theory: TheoryPoint[] = [
    ...
    },
    {
      ...
      points: [
        ...
        'External ID prevents confused-deputy attacks: when a third-party SaaS assumes your role it must pass an ExternalId you both agreed on — AWS explicitly states this value is NOT treated as a secret (it is visible to anyone with permission to view the role); its protection comes from being unguessable and vendor-generated, not from secrecy.',
  ...
  quiz: QuizQuestion[] = [
    ...
    },
    {
      ...
      options: [
        ...
        'Prevents confused-deputy attacks with an unguessable, vendor-generated identifier',
        'Enforces MFA for the assumed role',
        'Tags the session with the caller account ID'
      ],
      answer: 1,
      explanation: 'External ID prevents confused-deputy attacks, but AWS explicitly does NOT treat it as a secret — it is visible to anyone with permission to view the role, the same as any other trust policy condition value. Its protection comes from being unguessable and generated by the third party (not the customer), ensuring uniqueness per customer — not from being kept confidential.'
    },
    {
