...
const ALL_TOPICS: Topic[] = [
  ...
  { title: 'EC2 & Auto Scaling', route: '/aws/ec2', badge: 'Compute', description: 'EC2 instance types, AMIs, key pairs, security groups, EBS, and Auto Scaling Groups.', keyPoints: ['Instance family naming', 'AMI selection', 'Security group inbound rules', 'EBS volume types (gp3, io2)', 'ASG launch templates'], available: false },
  { title: 'ECS & EKS', route: '/aws/ecs-eks', badge: 'Compute', description: 'Container orchestration on AWS — ECS task definitions, Fargate, and EKS managed node groups.', keyPoints: ['ECS task and service', 'Fargate serverless containers', 'EKS managed node groups', 'ALB with ECS service', 'IRSA for pod IAM roles'], available: false },
  ...
  { title: 'S3', route: '/aws/s3', badge: 'Storage', description: 'Object storage — buckets, storage classes, versioning, lifecycle rules, replication, and presigned URLs.', keyPoints: ['S3 storage classes (Standard, IA, Glacier)', 'Versioning and delete markers', 'Lifecycle transition rules', 'Cross-region replication', 'Presigned URL generation'], available: false },
  { title: 'EBS, EFS & FSx', route: '/aws/ebs-efs', badge: 'Storage', description: 'Block (EBS), file (EFS/FSx), and their performance characteristics, mount targets, and use cases.', keyPoints: ['EBS gp3 vs io2', 'EFS multi-AZ NFS', 'FSx for Windows / Lustre', 'EFS mount with ECS', 'Backup with AWS Backup'], available: false },
  { title: 'IAM', route: '/aws/iam', badge: 'IAM', description: 'Users, groups, roles, policies, permission boundaries, SCPs, and the IAM evaluation logic.', keyPoints: ['Principle of least privilege', 'Policy JSON structure', 'IAM role assume role', 'Permission boundaries', 'Service Control Policies (SCP)'], available: false },
  { title: 'IAM Roles & Federation', route: '/aws/iam-roles', badge: 'IAM', description: 'Cross-account roles, OIDC federation, IRSA, AWS SSO, and identity federation patterns.', keyPoints: ['Cross-account AssumeRole', 'OIDC provider (GitHub Actions)', 'IRSA for Kubernetes pods', 'AWS IAM Identity Center (SSO)', 'STS temporary credentials'], available: false },
  { title: 'RDS & Aurora', route: '/aws/rds-aurora', badge: 'Databases', description: 'Managed relational databases — RDS Multi-AZ, Aurora Global, read replicas, and Parameter Groups.', keyPoints: ['RDS Multi-AZ failover', 'Aurora vs RDS performance', 'Read replicas', 'Aurora Serverless v2', 'Enhanced monitoring'], available: false },
