...
const ALL_TOPICS: Topic[] = [
  ...
  { title: 'AWS Cheat Sheet', route: '/aws/cheatsheet', badge: 'Reference', description: 'AWS CLI commands, service acronyms, IAM patterns, and common architecture quick reference.', keyPoints: ['aws configure; aws sts get-caller-identity', 'Key service acronyms: EC2, ECS, EKS, RDS, S3, IAM, VPC', 'Common patterns: ALB → ECS Fargate → RDS in private subnet'], available: true },
];
