...
# tofu apply        # only after plan verification`,
  ...
  { q: 'What is OpenTofu and how does it relate to Terraform?', options: ['OpenTofu is a Terraform plugin manager', 'OpenTofu is a community-maintained open-source fork of Terraform under the MPL 2.0 license', 'OpenTofu is HashiCorp enterprise version of Terraform', 'OpenTofu converts Terraform configs to CloudFormation'], answer: 1, explanation: 'OpenTofu is a community-led open-source fork of Terraform created after HashiCorp changed Terraform license from Mozilla Public License 2.0 to the Business Source License in August 2023. OpenTofu is governed by the Linux Foundation under the CNCF. It maintains compatibility with Terraform 1.6 and adds new features independently. OpenTofu uses the same HCL syntax and provider ecosystem as Terraform.' },
  ...
  { q: 'What is the BSL license change that led to the creation of OpenTofu?', a: 'In August 2023, HashiCorp changed Terraform license from Mozilla Public License 2.0, a permissive open-source license, to Business Source License 1.1. The BSL restricts using Terraform to build competing products or services, affecting companies that embedded Terraform in their own IaC platforms. In response, the community including Gruntwork, Spacelift, env0, Scalr, and others forked Terraform at version 1.5.7 and created OpenTofu under the CNCF, maintaining it as truly open source under MPL 2.0 with community governance through RFCs.' },
  ];
