...
const ALL_TOPICS: Topic[] = [
  { title: 'TypeScript Fundamentals',    route: '/typescript', badge: 'Foundations', available: false,
  ...
  { title: 'Primitive & Literal Types',  route: '/typescript', badge: 'Type System', available: false,
  ...
  { title: 'Interfaces & Type Aliases',  route: '/typescript', badge: 'Type System', available: false,
  ...
  { title: 'Union & Intersection Types', route: '/typescript', badge: 'Type System', available: false,
  ...
  { title: 'Enums & Tuples',             route: '/typescript', badge: 'Type System', available: false,
  ...
  { title: 'Generics Fundamentals',      route: '/typescript', badge: 'Generics', available: false,
  ...
  { title: 'Generic Patterns',           route: '/typescript', badge: 'Generics', available: false,
  ...
  { title: 'Utility Types',              route: '/typescript', badge: 'Advanced Types', available: false,
  ...
  { title: 'Mapped Types',               route: '/typescript', badge: 'Advanced Types', available: false,
  ...
  { title: 'Template Literal Types',     route: '/typescript', badge: 'Advanced Types', available: false,
  ...
  { title: 'Conditional Types',          route: '/typescript', badge: 'Advanced Types', available: false,
  ...
  { title: 'Decorators',                 route: '/typescript', badge: 'OOP', available: false,
  ...
  { title: 'Classes & Visibility',       route: '/typescript', badge: 'OOP', available: false,
  ...
  { title: 'tsconfig Deep Dive',         route: '/typescript', badge: 'Tooling', available: false,
  ...
  { title: 'TypeScript with Frameworks', route: '/typescript', badge: 'Tooling', available: false,
  ...
  { title: 'Type Guards & Narrowing',     route: '/typescript', badge: 'Type System', available: false,
  ...
  { title: 'Declaration Files (d.ts)',    route: '/typescript', badge: 'Tooling', available: false,
  ...
  { title: 'Module System & Namespaces', route: '/typescript', badge: 'Tooling', available: false,
  ...
  { title: 'Strict Mode & Migration',    route: '/typescript', badge: 'Foundations', available: false,
  ...
  { title: 'TypeScript Performance',     route: '/typescript', badge: 'Tooling', available: false,
  ...
  { title: 'TypeScript Cheat Sheet',     route: '/typescript', badge: 'Reference', available: false,
  ...
  { title: 'TypeScript Interview Prep',  route: '/typescript', badge: 'Reference', available: false,
