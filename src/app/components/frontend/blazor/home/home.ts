...
const ALL_TOPICS: Topic[] = [
  ...
  { title: 'Error Handling & ErrorBoundary', route: '/blazor', badge: 'Advanced', available: false,
  ...
  { title: 'Streaming Rendering',           route: '/blazor', badge: 'Foundations', available: false,
  ...
  { title: 'Sections & Layouts',            route: '/blazor', badge: 'Components', available: false,
  ...
  { title: 'SEO & Head Metadata',           route: '/blazor', badge: 'Foundations', available: false,
  ...
  { title: 'Component Virtualization',      route: '/blazor', badge: 'Components', available: false,
  ...
  { title: 'Testing with bUnit',            route: '/blazor', badge: 'Reference', available: false,
  ...
  { title: 'Progressive Enhancement',       route: '/blazor', badge: 'Foundations', available: false,
  ...
  { title: 'Blazor Performance',            route: '/blazor', badge: 'Advanced', available: false,
