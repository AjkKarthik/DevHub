...
const ALL_TOPICS: Topic[] = [
  { title: 'HTML Fundamentals',          route: '/html/fundamentals', badge: 'Foundations', available: true,
  ...
  { title: 'Headings & Paragraphs',      route: '/html/headings-paragraphs', badge: 'Text & Media', available: true,
  ...
  { title: 'Input Types & Attributes',   route: '/html/input-types', badge: 'Forms', available: true,
  ...
  { title: 'Landmark Elements',          route: '/html/landmark-elements', badge: 'Semantic', available: true,
  ...
  { title: 'HTML SEO',                    route: '/html/seo', badge: 'Semantic', available: true,
    description: 'Title, canonical, robots meta, JSON-LD structured data, Open Graph, hreflang, and Core Web Vitals — all the HTML signals that drive search rankings.',
    keyPoints: ['JSON-LD: preferred by Google; embed in <script type="application/ld+json">', 'canonical consolidates duplicate-URL link equity to the preferred version', 'Core Web Vitals (LCP, CLS, INP) are ranking signals with direct HTML impact'] },
  ...
  { title: 'ARIA Roles & Attributes',    route: '/html/aria-roles', badge: 'Accessibility', available: true,
  ...
  { title: 'Focus Management',           route: '/html/focus-management', badge: 'Accessibility', available: true,
  ...
  { title: 'HTML Performance',            route: '/html/performance', badge: 'HTML5 APIs', available: true,
    description: 'Resource hints (preload/prefetch/preconnect), loading=lazy, fetchpriority, defer vs async, and critical rendering path optimisation.',
    keyPoints: ['fetchpriority=high on LCP image: one-line win for Core Web Vitals', 'preload: fetch now for this page; prefetch: fetch idle for next page', 'defer preserves script order; async does not — never use async on dependent scripts'] },
  { title: 'HTML5 Browser APIs',          route: '/html/apis', badge: 'HTML5 APIs', available: true,
    description: 'Geolocation, Notifications, File API, Drag & Drop, Clipboard, and Web Share — native browser capabilities accessible from JavaScript.',
    keyPoints: ['Always feature-detect: if ("share" in navigator) before calling navigator.share()', 'dragover must call preventDefault() — otherwise the drop event never fires', 'Geolocation, Notifications, and Clipboard readText() all require HTTPS and user permission'] },
  { title: 'HTML5 Storage APIs',         route: '/html/storage-apis', badge: 'HTML5 APIs', available: true,
  ...
  { title: 'Drag & Drop API',            route: '/html/drag-drop', badge: 'HTML5 APIs', available: true,
