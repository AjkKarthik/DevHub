...
const ALL_TOPICS: Topic[] = [
  { title: 'Core Web Vitals Overview',   route: '/performance', badge: 'Core Web Vitals', available: false,
  ...
  { title: 'Largest Contentful Paint',   route: '/performance', badge: 'Core Web Vitals', available: false,
  ...
  { title: 'Interaction to Next Paint',  route: '/performance', badge: 'Core Web Vitals', available: false,
  ...
  { title: 'Cumulative Layout Shift',    route: '/performance', badge: 'Core Web Vitals', available: false,
  ...
  { title: 'Critical Rendering Path',   route: '/performance', badge: 'Rendering', available: false,
  ...
  { title: 'Browser Rendering Pipeline', route: '/performance', badge: 'Rendering', available: false,
  ...
  { title: 'Resource Hints',             route: '/performance', badge: 'Loading', available: false,
  ...
  { title: 'HTTP/2 & HTTP/3',            route: '/performance', badge: 'Loading', available: false,
  ...
  { title: 'Caching & Service Workers',  route: '/performance', badge: 'Loading', available: false,
  ...
  { title: 'Image Optimisation',         route: '/performance', badge: 'Assets', available: false,
  ...
  { title: 'Font Performance',           route: '/performance', badge: 'Assets', available: false,
  ...
  { title: 'JavaScript Performance',     route: '/performance', badge: 'JavaScript', available: false,
  ...
  { title: 'Third-Party Scripts',        route: '/performance', badge: 'JavaScript', available: false,
  ...
  { title: 'Performance Measurement',    route: '/performance', badge: 'Measurement', available: false,
  ...
  { title: 'Real User Monitoring (RUM)', route: '/performance', badge: 'Measurement', available: false,
  ...
  { title: 'Server-Side Rendering & Streaming', route: '/performance', badge: 'Rendering', available: false,
  ...
  { title: 'CSS Performance',             route: '/performance', badge: 'Assets', available: false,
  ...
  { title: 'Web Workers & Off-Main-Thread', route: '/performance', badge: 'JavaScript', available: false,
  ...
  { title: 'Performance Budgets & CI',    route: '/performance', badge: 'Measurement', available: false,
  ...
  { title: 'Speculation Rules API',       route: '/performance', badge: 'Loading', available: false,
  ...
  { title: 'Performance Cheat Sheet',    route: '/performance', badge: 'Reference', available: false,
  ...
  { title: 'Performance Interview Prep', route: '/performance', badge: 'Reference', available: false,
