...
const ALL_TOPICS: Topic[] = [
  { title: 'CSS Fundamentals',           route: '/css/fundamentals', badge: 'Foundations', available: true,
  ...
  { title: 'Backgrounds & Borders',      route: '/css/backgrounds-borders', badge: 'Visual', available: true,
  ...
  { title: 'Tailwind CSS',               route: '/css/tailwind', badge: 'Modern CSS', available: true,
  ...
  { title: 'CSS Transforms',             route: '/css/css-transforms', badge: 'Modern CSS', available: true,
    description: 'translate, rotate, scale, skew, 3D transforms, perspective, transform-origin — composited GPU animations.',
    keyPoints: ['transform: translate/rotate/scale composited — no layout/paint cost', 'perspective() enables 3D — apply on the parent container', 'transform-origin sets the pivot point for rotation and scale'] },
  { title: 'CSS Filters & Effects',      route: '/css/css-filters', badge: 'Modern CSS', available: true,
    description: 'filter, backdrop-filter, mix-blend-mode, isolation — GPU-accelerated image and layer effects.',
    keyPoints: ['filter: blur/brightness/contrast/grayscale/hue-rotate/drop-shadow applied to the element', 'backdrop-filter: blur() — frosted glass effects on overlays', 'mix-blend-mode: how layers blend (multiply, screen, overlay)'] },
  { title: 'Scroll-Driven Animations',   route: '/css/scroll-driven-animations', badge: 'Modern CSS', available: true,
  ...
  { title: 'CSS Cheat Sheet',            route: '/css/cheatsheet', badge: 'Reference', available: true,
  ...
  { title: 'CSS Interview Prep',         route: '/css/interview-prep', badge: 'Reference', available: true,
