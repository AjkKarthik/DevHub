...
const ALL_TOPICS: Topic[] = [
  // Core
  {
    title: 'Signals & State', route: '/counter', badge: 'Core',
  ...
  {
    title: 'Template Syntax', route: '/templates', badge: 'Core',
  ...
  {
    title: 'Directives', route: '/directives', badge: 'Core',
  ...
  {
    title: 'Lifecycle Hooks', route: '/lifecycle', badge: 'Core',
  ...
  {
    title: 'Pipes', route: '/pipes', badge: 'Core',
  ...
  {
    title: 'Input / Output Signals', route: '/parent-child', badge: 'Core',
  ...
  {
    title: 'Content Projection', route: '/content-projection', badge: 'Core',
  ...
  // DI & Architecture
  {
    title: 'Dependency Injection', route: '/di', badge: 'DI',
  ...
  {
    title: 'Signal Store Pattern', route: '/store', badge: 'State',
  ...
  // Router
  {
    title: 'Routing', route: '/routing', badge: 'Router',
  ...
  // Forms
  {
    title: 'Forms: Template vs Reactive', route: '/forms', badge: 'Forms',
  ...
  {
    title: 'FormArray — Dynamic Fields', route: '/form-array', badge: 'Forms',
  ...
  {
    title: 'Reactive Forms + Service', route: '/todo', badge: 'Forms',
  ...
  {
    title: 'Zod + Reactive Forms', route: '/zod-forms', badge: 'Forms',
  ...
  {
    title: 'Custom Validators', route: '/custom-validators', badge: 'Forms',
  ...
  {
    title: 'Control Value Accessor', route: '/cva', badge: 'Forms',
  ...
  // HTTP & Async
  {
    title: 'HTTP Client', route: '/http', badge: 'HTTP',
  ...
  {
    title: 'RxJS Operators', route: '/rxjs', badge: 'RxJS',
  ...
  // Performance
  {
    title: '@defer Blocks', route: '/defer', badge: 'Perf',
  ...
  {
    title: 'Change Detection (OnPush)', route: '/change-detection', badge: 'Perf',
  ...
  // UI
  {
    title: 'Angular Material', route: '/material', badge: 'UI',
  ...
  {
    title: 'Angular CDK', route: '/cdk', badge: 'UI',
  ...
  {
    title: 'Angular Animations', route: '/animations', badge: 'UI',
  ...
  // 3rd Party
  {
    title: 'Charts (Chart.js)', route: '/charts', badge: '3rd Party',
  ...
  {
    title: 'AG Grid', route: '/ag-grid', badge: '3rd Party',
  ...
  {
    title: 'TanStack Query', route: '/tanstack-query', badge: '3rd Party',
  ...
  {
    title: 'date-fns', route: '/date-fns', badge: '3rd Party',
  ...
  {
    title: 'Tailwind CSS', route: '/tailwind', badge: '3rd Party',
  ...
  // Testing
  {
    title: 'Testing', route: '/testing', badge: 'Testing',
  ...
  // Modern APIs
  {
    title: 'resource() API', route: '/resource-api', badge: 'Core',
  ...
  {
    title: 'NgRx Signals Store', route: '/ngrx-signals', badge: 'State',
  ...
  {
    title: 'DestroyRef + takeUntilDestroyed', route: '/destroy-ref', badge: 'Core',
  ...
  {
    title: 'linkedSignal()', route: '/linked-signal', badge: 'Core',
  ...
  {
    title: 'Zoneless Angular', route: '/zoneless', badge: 'Perf',
  ...
  // Forms
  {
    title: 'Dynamic / Schema Forms', route: '/dynamic-forms', badge: 'Forms',
  ...
  {
    title: 'Multi-step Wizard Form', route: '/wizard-form', badge: 'Forms',
  ...
  // Router
  {
    title: 'Route Resolvers', route: '/route-resolvers', badge: 'Router',
  ...
  {
    title: 'Preloading Strategies', route: '/preloading', badge: 'Perf',
  ...
  // Testing
  {
    title: 'E2E with Playwright', route: '/e2e', badge: 'Testing',
  ...
  {
    title: 'Component Harnesses', route: '/harnesses', badge: 'Testing',
  ...
  // Platform
  {
    title: 'NgOptimizedImage', route: '/ng-image', badge: 'Perf',
  ...
  {
    title: 'Web Workers', route: '/web-workers', badge: 'Perf',
  ...
  {
    title: 'PWA / Service Worker', route: '/pwa', badge: 'Perf',
  ...
  {
    title: 'i18n / Transloco', route: '/i18n', badge: 'Core',
  ...
  {
    title: 'SSR + Hydration', route: '/ssr', badge: 'Perf',
  ...
  // Reference
  {
    title: 'Angular Cheat Sheet', route: '/cheatsheet', badge: 'Reference',
  ...
  {
    title: 'Common Angular Errors', route: '/errors', badge: 'Reference',
  ...
  {
    title: "What's New in Angular", route: '/whats-new', badge: 'Reference',
  ...
  {
    title: 'Mini Projects', route: '/mini-projects', badge: 'Reference',
  ...
  {
    title: 'Learning Paths', route: '/learning-paths', badge: 'Reference',
