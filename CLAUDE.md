...
- **Linux hub**: 19 trackable topic pages + 2 reference pages (21 cards total). Feature-complete.
  ...
  Phase 10: 9 of 19 topics have subtopics (`/linux/fundamentals`, `/linux/file-system`,
  ...
  2026-07-23) — see "Linux hub subtopic wiring" section above for the `LinuxNavComponent` accordion structural fix and the
