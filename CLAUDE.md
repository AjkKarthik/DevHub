...
- **Service Mesh hub**: 19 trackable topic pages + 2 reference (21 cards total). Feature-complete.
  ...
  Phase 10: 2 of 19 topics have subtopics (`/service-mesh/fundamentals`,
  `/service-mesh/istio-architecture`, 2026-07-28) — see "Service Mesh hub subtopic wiring" section
  below for the `MeshNavComponent` accordion structural fix and the `mesh-fundamentals`
  SUBTOPICS-map collision resolution (`istio-architecture` was collision-free, left as a bare
  key).
