...
- **Linux hub**: 19 trackable topic pages + 2 reference pages (21 cards total). Feature-complete.
  ...
  Phase 10: 14 of 19 topics have subtopics (`/linux/fundamentals`, `/linux/file-system`,
  ...
  `/linux/systemd`, 2026-07-24) — see "Linux hub subtopic wiring" section above for the `LinuxNavComponent` accordion structural fix and the
