...
- **AWS hub**: 21 trackable topic pages + 1 cheatsheet reference (22 cards total). Feature-complete.
  ...
  Phase 10: 8 of 21 topics have subtopics (`/aws/fundamentals`, `/aws/ec2`, `/aws/ecs-eks`,
  `/aws/vpc`, `/aws/route53-cloudfront`, `/aws/s3`, `/aws/ebs-efs`, `/aws/iam`, 2026-07-21) —
  see "AWS hub subtopic wiring" section above for the `AwsNavComponent` accordion structural
  fix and the `aws-fundamentals` SUBTOPICS-map collision resolution.
