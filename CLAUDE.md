...
- **Terraform/IaC hub**: 21 trackable topic pages + 2 reference (23 cards total). Feature-complete.
  ...
  Phase 10: 10 of 21 topics have subtopics (`/terraform/fundamentals`, `/terraform/providers`,
  ...
  `/terraform/remote-backends`, 2026-07-25) — see "Terraform
  ...
  `resources`, `data-sources`, `expressions`, `state`, and `remote-backends` were all
