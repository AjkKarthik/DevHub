...
- **Linux hub**: 19 trackable topic pages + 2 reference pages (21 cards total). Feature-complete.
  ...
  Phase 10: 2 of 19 topics have subtopics (`/linux/fundamentals`, `/linux/file-system`,
  2026-07-23) — see "Linux hub subtopic wiring" section above for the `LinuxNavComponent`
  accordion structural fix and the `linux-fundamentals` SUBTOPICS-map collision resolution
  (collided with the JavaScript hub's own bare `fundamentals` topic key).
